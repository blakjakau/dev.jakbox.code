...
window.ace_themes = exports.themesByName
...
var overlayPage = require('./menu_tools/overlay_page').overlayPage;
function showSettingsMenu(editor, callback) {
...
module.exports.init = function(editor, initCallback) {
    ...
    Editor.prototype.showSettingsMenu = function(callback) {
        showSettingsMenu(this, callback);
    };
    initCallback && 'function' == typeof initCallback && initCallback()
};
});                (function() {
