/*!
  ...
  static import of hljs 11.9.0
  converted to ESM for inclusion in Code PWA
  
  original minified: https://unpkg.com/@highlightjs/cdn-assets@11.9.0/highlight.min.js
 */
var hljs = (function () {
	"use strict"
	function e(n) {
	...
	function Q(e) {
		...
		class i {
			...
			exec(e) {
				...
				return (
					t && ((this.regexIndex += t.position + 1), this.regexIndex === this.count && this.considerAll()), t
				)
			}
		}
			...
			return {
				...
				keywords: {
					...
					keyword: ((e, { exceptions: n, when: t } = {}) => {
						const a = t
						return (
							(n = n || []), e.map((e) => (e.match(/\|\d+$/) || n.includes(e) ? e : a(e) ? e + "|0" : e))
						)
					})(l, { when: (e) => e.length < 3 }),
					literal: a,
					type: i,
